...
public class Guia9EjercicioExtra2 {
    ...
    AhorcadoService ss = new AhorcadoService();
    Ahorcado x = ss.crearJuego();
    System.out.println("La palabra tiene una longitud de "+ss.longitud(x)+" letras");
    ss.buscar(x);
    }
